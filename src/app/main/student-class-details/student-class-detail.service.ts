...
export class StudentClassDetailService {
    ...
    getStreamValues(classId: string): Observable<any[]> {
        let stream = '' 
        if (classId === "69257ab5-e836-46f1-b888-dfae5da5489c") stream = 'StreamOfEducation' 
        else if(classId === "e0302e36-a8a7-49a0-b621-21d48986c43e") stream = 'StreamOfEducationFor12th'
        let streamRequest = this.http.GetMasterDataByType({ DataType: 'DataValues', ParentId: stream, SelectTitle: 'Streams' });
        return forkJoin([streamRequest])
    }
