...
export class VCSchoolVisitReportService {
    ...
    getDropdownforVCSchoolVisitReporting(userModel: UserModel): Observable<any[]> {
        ...
        let schoolRequest = this.http.GetMasterDataByType({ DataType: 'SchoolsByUserId', RoleId: userModel.RoleCode, UserId: userModel.UserTypeId, SelectTitle: 'School' }, false);
