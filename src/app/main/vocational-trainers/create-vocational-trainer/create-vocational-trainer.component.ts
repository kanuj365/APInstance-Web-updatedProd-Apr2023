...
export class CreateVocationalTrainerComponent
    extends BaseComponent<VocationalTrainerModel>
    implements OnInit
{
    ...
    ngOnInit(): void {
        this.vocationalTrainerService
            .getDropdownforVocationalTrainer(this.UserModel)
            .subscribe((results) => {
                ...
                this.route.paramMap.subscribe((params) => {
                    if (params.keys.length > 0) {
                        ...
                        if (
                            ...
                            this.idVTPEditable = false;
                            this.vocationalTrainerModel =
                                new VocationalTrainerModel();
                        } else {
                            ...
                            this.vocationalTrainerService
                                ...
                                .subscribe((response: any) => {
                                    ...
                                    if (
                                        ...
                                        this.idVTPEditable = true;
                                        this.vocationalTrainerModel.RequestType =
                                    ...
                                    if (
                                        ...
                                        this.vocationalTrainerForm
                                            .get("DateOfResignation")
                                            .setValue(
                                                this.getDateValue(
                                                    this.vocationalTrainerModel
                                                        .DateOfResignation
                                        ...
                                        let dateOfResignationCtrl =
                                            this.vocationalTrainerForm.get(
                                                "DateOfResignation"
                                            );
                                        this.onChangeDateEnableDisableCheckBox(
                                            this.vocationalTrainerForm,
                                            dateOfResignationCtrl
                                        );
                                    }

                                    this.onChangeVTP(
                                        this.vocationalTrainerModel.VTPId
                                    );
                                    this.vocationalTrainerForm =
                                        this.createVocationalTrainerForm();
                                });
                        }
                    }
                });
    ...
    onChangeVTP(vtpId) {
        this.commonService
            .GetMasterDataByType({
                DataType: "VocationalCoordinatorsByUserId",
    ...
    saveOrUpdateVocationalTrainerDetails() {
        ...
        this.vocationalTrainerModel.AcademicYearId =
            this.UserModel.AcademicYearId;

        this.vocationalTrainerService
            .createOrUpdateVocationalTrainer(this.vocationalTrainerModel)
            .subscribe(
                (vocationalTrainerResp: any) => {
                    if (vocationalTrainerResp.Success) {
                        this.zone.run(() => {
                            ...
                            this.router.navigate([
                                RouteConstants.VocationalTrainer.List,
                            ]);
                        });
                    } else {
                        var errorMessages = this.getHtmlMessage(
                            vocationalTrainerResp.Errors
                        );
    ...
    createVocationalTrainerForm(): FormGroup {
        return this.formBuilder.group({
            ...
            VTPId: new FormControl(
                {
                    value: this.vocationalTrainerModel.VTPId,
            ...
            VCId: new FormControl(
                {
                    value: this.vocationalTrainerModel.VCId,
                    disabled: this.PageRights.IsReadOnly,
                },
                Validators.required
            ),
            FirstName: new FormControl(
                {
                    value: this.vocationalTrainerModel.FirstName,
                    disabled: this.PageRights.IsReadOnly,
                },
                [
                    Validators.required,
                    ...
                    Validators.pattern(
                        this.Constants.Regex
                            .CharWithTitleCaseSpaceAndSpecialChars
                    ),
                ]
            ),
            MiddleName: new FormControl(
                {
                    value: this.vocationalTrainerModel.MiddleName,
                    disabled: this.PageRights.IsReadOnly,
                },
                [
            ...
            LastName: new FormControl(
                {
                    value: this.vocationalTrainerModel.LastName,
                    disabled: this.PageRights.IsReadOnly,
                },
                [
                    Validators.maxLength(50),
            ...
            FullName: new FormControl(
                {
                    value: this.vocationalTrainerModel.FullName,
                    disabled: this.PageRights.IsReadOnly,
                },
            ...
            Mobile: new FormControl(
                {
                    value: this.vocationalTrainerModel.Mobile,
                    disabled: this.PageRights.IsReadOnly,
                },
                [
                    Validators.required,
                    ...
                    Validators.pattern(this.Constants.Regex.MobileNumber),
                ]
            ),
            Mobile1: new FormControl(
                {
                    value: this.vocationalTrainerModel.Mobile1,
                    disabled: this.PageRights.IsReadOnly,
                },
                [
                    Validators.maxLength(10),
            ...
            Email: new FormControl(
                {
                    value: this.vocationalTrainerModel.Email,
                    disabled:
            ...
            Gender: new FormControl(
                {
                    value: this.vocationalTrainerModel.Gender,
                    disabled: this.PageRights.IsReadOnly,
                },
            ...
            DateOfBirth: new FormControl(
                {
                    value: new Date(this.vocationalTrainerModel.DateOfBirth),
                    disabled: this.PageRights.IsReadOnly,
                },
                Validators.required
            ),
            SocialCategory: new FormControl(
                {
                    value: this.vocationalTrainerModel.SocialCategory,
                    disabled: this.PageRights.IsReadOnly,
                },
                Validators.maxLength(100)
            ),
            NatureOfAppointment: new FormControl(
                {
                    value: this.vocationalTrainerModel.NatureOfAppointment,
                    disabled: this.PageRights.IsReadOnly,
                },
                Validators.maxLength(100)
            ),
            AcademicQualification: new FormControl(
                {
                    value: this.vocationalTrainerModel.AcademicQualification,
                    disabled: this.PageRights.IsReadOnly,
                },
                Validators.maxLength(150)
            ),
            ProfessionalQualification: new FormControl(
                {
                    value: this.vocationalTrainerModel
                        .ProfessionalQualification,
                    disabled: this.PageRights.IsReadOnly,
                },
                Validators.maxLength(150)
            ),
            ProfessionalQualificationDetails: new FormControl(
                {
                    value: this.vocationalTrainerModel
            ...
            IndustryExperienceMonths: new FormControl(
                {
                    value: this.vocationalTrainerModel.IndustryExperienceMonths,
                    disabled: this.PageRights.IsReadOnly,
                },
                Validators.pattern(this.Constants.Regex.Number)
            ),
            TrainingExperienceMonths: new FormControl(
                {
                    value: this.vocationalTrainerModel.TrainingExperienceMonths,
                    disabled: this.PageRights.IsReadOnly,
                },
                Validators.pattern(this.Constants.Regex.Number)
            ),
            AadhaarNumber: new FormControl(
                {
                    value: this.maskingStudentAadhaarNo(
                        this.vocationalTrainerModel.AadhaarNumber
                    ),
                    disabled: this.PageRights.IsReadOnly,
                },
                [
            ...
            DateOfJoining: new FormControl(
                {
                    value: new Date(this.vocationalTrainerModel.DateOfJoining),
                    disabled: this.PageRights.IsReadOnly,
                },
                Validators.required
            ),
            DateOfResignation: new FormControl({
                value: this.getDateValue(
                    this.vocationalTrainerModel.DateOfResignation
                ),
                disabled: this.PageRights.IsReadOnly,
            }),
            IsActive: new FormControl({
                value: this.vocationalTrainerModel.IsActive,
                disabled: this.PageRights.IsReadOnly,
            }),
        });
    }
